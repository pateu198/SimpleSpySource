...
ImageLabel.Image = "http://www.roblox.com/asset/?id=8476348446"
...
ImageLabel_2.Image = "http://www.roblox.com/asset/?id=8476348446"
...
ImageLabel_3.Image = "http://www.roblox.com/asset/?id=8476348446"
	...
	RunService:BindToRenderStep("SIMPLESPY_CURSOR", 1, function()
		if mouseInGui and _G.SimpleSpyExecuted then
			...
			if inRange and not sideClosed and not closed then
				customCursor.Image = type == "B" and "rbxassetid://8476348446"
					or type == "X" and "rbxassetid://8476348446"
					or type == "Y" and "rbxassetid://8476348446"
			elseif inRange and not closed and type == "Y" or type == "B" then
				customCursor.Image = "rbxassetid://8476348446"
			elseif customCursor.Image ~= "rbxassetid://8476348446" then
				customCursor.Image = "rbxassetid://8476348446"
			end
		else
...
function genScript(remote, args)
	...
	gen = "-- Script generated by pateut - credits to pateut\n\n" .. gen
	prevTables = {}
	return gen
end
